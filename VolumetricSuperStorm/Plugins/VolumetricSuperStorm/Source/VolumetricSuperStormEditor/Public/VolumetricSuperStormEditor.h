...
/**
 * @file VolumetricSuperStormEditor.h
 * @brief Declares the storm editor module and its tool window entry points.
 */
...
class FVolumetricSuperStormEditorModule : public IModuleInterface
{
public:
