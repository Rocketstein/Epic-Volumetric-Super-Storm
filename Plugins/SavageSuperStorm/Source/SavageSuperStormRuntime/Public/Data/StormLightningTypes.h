...
struct SAVAGESUPERSTORMRUNTIME_API FStormLightningMaterialState
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct SAVAGESUPERSTORMRUNTIME_API FStormLightningCue
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct SAVAGESUPERSTORMRUNTIME_API FStormLightningSequenceSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct SAVAGESUPERSTORMRUNTIME_API FStormLightningContext
{
	GENERATED_BODY()
