...
UCLASS(Transient)
class SAVAGESUPERSTORMRUNTIME_API UStormReplayHistoryBookmark : public UObject
{
	GENERATED_BODY()
...
class SAVAGESUPERSTORMRUNTIME_API UStormReplayHistorySession : public UObject
{
	GENERATED_BODY()
