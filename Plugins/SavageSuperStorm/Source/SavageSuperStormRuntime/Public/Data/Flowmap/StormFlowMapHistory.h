...
USTRUCT()
struct SAVAGESUPERSTORMRUNTIME_API FStormFlowMapOp
{
	GENERATED_BODY()
...
USTRUCT()
struct SAVAGESUPERSTORMRUNTIME_API FStormFlowMapEdit
{
	GENERATED_BODY()
...
USTRUCT()
struct SAVAGESUPERSTORMRUNTIME_API FStormFlowMapHistory
{
	GENERATED_BODY()
