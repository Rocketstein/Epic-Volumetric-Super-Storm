...
/**
 * @file SStormProfileCompositePreview.cpp
 * @brief Implements the composite preview of the bottom, top, and anvil profiles.
 */
...
namespace
{
    ...
    static const TCHAR* CompositePreviewMaterialPath =
        TEXT("/VolumetricSuperStorm/VolumetricSuperStorm/VerticalProfile/Internal/M_StormProfileCompositePreview.M_StormProfileCompositePreview");
}
