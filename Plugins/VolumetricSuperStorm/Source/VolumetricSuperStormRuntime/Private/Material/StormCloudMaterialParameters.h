...
namespace VolumetricSuperStorm::CloudMaterialParams
{
	...
	inline const FName StaticGlowIntensity(TEXT("StormStaticGlowIntensity"));
	inline const FName StaticGlowColor(TEXT("StormStaticGlowColor"));
	inline const FName GlowExtent(TEXT("GlowExtentN"));
