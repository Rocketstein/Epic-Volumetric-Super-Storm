...
class VOLUMETRICSUPERSTORMRUNTIME_API UStormLightningComponent : public UActorComponent
{
	GENERATED_BODY()
...
private:
	...
	/** Shared by the material flash and the ground bolt so the glow sits over the strike. */
	FVector SequenceStrikeCenterN = FVector::ZeroVector;
