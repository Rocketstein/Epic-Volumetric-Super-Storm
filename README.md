...
![Volumetric Super Storm](vss.jpg)
...
1. Open the Unreal project at `VolumetricSuperStorm/VolumetricSuperStorm.uproject`.
2. Add a **Directional Light**, **Sky Atmosphere**, and **Volumetric Cloud** component to the level.
3. Place one **Volumetric Super Storm Actor** in the scene.
4. Choose the included `M_StormMinimalSetup` material, or integrate `MF_Storm_Global` into an existing cloud material.
5. Adjust the actor’s shape and motion settings to establish the overall storm.
6. Open the **Vertical Profile** and **Flow Map** editors to paint finer structural and directional detail.
7. Save the result as reusable assets or as a complete **Storm Preset**.

## Documentation

- [Product page on Fab](https://www.fab.com/listings/1c2d0fea-7278-49f0-9559-3efef3076ac0)
- [Fab listing draft](VolumetricSuperStorm/Docs/Release/FabListing.md)
